...
#define __________________QWERTY_L2_STFA___________ SFTT_A, KC_S, KC_D, KC_F, KC_G
...
#define __MOUSE_L1 XXXXXXX, MS_WHLD, MS_UP, MS_WHLU, XXXXXXX
#define __MOUSE_L2 KC_LSFT, MS_LEFT, MS_DOWN, MS_RGHT, XXXXXXX
#define __MOUSE_L3 UNDO, CUT, COPY, PASTE, BOLDFACE

#define __MOUSE_R1 XXXXXXX, MS_ACL2, XXXXXXX, XXXXXXX, XXXXXXX
#define __MOUSE_R2 KC_INS, MS_ACL0, MS_BTN1, MS_BTN2, MS_BTN3
...
#define THUMB_L3 LT(_BASE,KC_DEL)
