...
[_SETTINGS] = LAYOUT(
//|-------------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
   _______,     C(MS_WHLD), XXXXXXX, A(KC_0), A(KC_F4),XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RESET,
   KC_TAB,/*|*/ C(MS_WHLU), A(KC_4), A(KC_5), A(KC_6), KC_X,                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
