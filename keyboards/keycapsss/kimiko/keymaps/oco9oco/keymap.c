...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    ...
    KC_LCTL, KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,             KC_H,    MS_BTN3, MS_WHLU, KC_L,    KC_SCLN, XXXXXXX, //
    KC_ENT,  KC_B,    KC_Z,    KC_X,    KC_C,    KC_V, TG(_FACT),  XXXXXXX, KC_N,    MS_WHLD, MS_BTN1, MS_BTN2, KC_SLSH, XXXXXXX,//
// ╰──────────────────────────────────────────────────────┤       ├──────────────────────────────────────────────────────╯
                 KC_I,    KC_O,  KC_LALT, KC_SPC,  KC_LCTL,             KC_ENT, THUMB_R3, TO(_BASE),XXXXXXX,XXXXXXX
),

[_FACTORIO] = LAYOUT_charybdis_wrapper(
// FACTORIO: Automation Focus
// |--------|--------|--------|--------|--------|--------|---|---|--------|--------|--------|--------|--------|--------|
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Quickbar 1~5
    KC_T,    KC_G,    KC_Q,    KC_W,    KC_E,    KC_R,               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Q:Pipette/Cancel, E:Inv, R:Rotate
    KC_LCTL, KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Shift:Ghost, F:Pick up
    KC_TAB,  KC_B,    KC_Z,    KC_X,    KC_C,    KC_V, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,// B:Blueprint, X:Switch bar, C:Shoot
// ╰──────────────────────────────────────────────────────┤       ├──────────────────────────────────────────────────────╯
                      KC_M,    KC_ENT,  KC_LCTL, KC_SPC,  MO(_FACT_ALT),          XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                      // M:Map, ENT:Vehicle, ALT:Alt-mode, SPC:Shoot/Confirm
),

[_FACT_ALT] = LAYOUT_charybdis_wrapper(
// FACTORIO: Automation Focus
// |--------|--------|--------|--------|--------|--------|---|---|--------|--------|--------|--------|--------|--------|
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Quickbar 1~5
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Q:Pipette/Cancel, E:Inv, R:Rotate
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_P,    KC_H,             XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, // Shift:Ghost, F:Pick up
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,// B:Blueprint, X:Switch bar, C:Shoot
// ╰──────────────────────────────────────────────────────┤       ├──────────────────────────────────────────────────────╯
                      KC_M,    KC_ENT,  KC_LALT, KC_SPC,  KC_LCTL,          XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                      // M:Map, ENT:Vehicle, ALT:Alt-mode, SPC:Shoot/Confirm
),
...
//     KC_U,    XXXXXXX, MS_WHLD, MS_UP, MS_WHLU, XXXXXXX,                            XXXXXXX,  MS_ACL2, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
//     KC_P,    KC_LSFT, MS_LEFT, MS_DOWN, MS_RGHT, XXXXXXX,                            XXXXXXX,  MS_ACL0, MS_BTN1, MS_BTN2, MS_BTN3, KC_ENT,
...
// const uint16_t PROGMEM onehand_end_combo[]  = {MS_BTN2, KC_UP, COMBO_END};
