...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    A(KC_F4), C(KC_F1), MS_WHLD, MS_UP, MS_WHLU,   KC_F5,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
     KC_LNG1,  KC_LSFT, MS_LEFT, MS_DOWN, MS_RGHT,   KC_F6,                         XXXXXXX, MS_ACL0, MS_BTN1, MS_BTN2, MS_BTN3, QK_MAKE,
...
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
    ...
    G(KC_R),  MS_WHLD, KC_LEFT, KC_DOWN, KC_RGHT,  KC_SPC,                            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
